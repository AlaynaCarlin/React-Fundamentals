    ...
    return (
        <div className='main'>
            <div className='mainDiv'>
                ...
                <p>Below are some of the resources that we used throughout this app. Note: You'll have one challenge where you will be asked to 
                    make this page better.</p>
                <ul>
                    <li>
                    ...
                    <li>
                        <a href="https://www.pluralsight.com/coursr/react-js-getting-started" target="_blank">
                    ...
                    <li>
                        <a href="https://github.com/bmorelli25/interactive-bitcion-price-chart" target="_blank">
                            Bitcoin
                        </a>
                    </li>
                    <li>
