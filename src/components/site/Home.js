import {Link} from 'react-router-dom'; //! if this doesn't work the issue is in package.json
    ...
    return(
        <div className='main'>
            <div className='mainDiv'>
                ...
                <p>
                    This app is intended to be a starter/tutorial app for your upcoming project and a learning sandbox for you in months and years to come
                    should you continue to develop software with React. In this application, we will work through some of the basic React concepts, build 
                    out some small applications, and then unleash you to build your own applications.
                </p>
                <hr />
                <h1>Important Notes</h1>
                <ul>
                    <li>Being component based, you can move on to the next module</li>
                    <li>The style is intentionally left bland in some spots. Just a sandbox.</li>
