...
// * Functional Component - components are like javascript functions. They accept arbitrary inputs (props) and return react elements
...
// * elements can represent DOM tags or user-defined components 
    return(
        <div className='main'>
    ...
    return(
        <div className='main'>
            <div className='mainDiv'>
                ...
                <button onClick={() => setClicks(clicks + 1 )}>Click to update the document title</button>
            </div>
        </div>
    );
};
